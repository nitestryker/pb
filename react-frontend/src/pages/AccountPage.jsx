...
const AccountPage = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        setStats(mockStats);
        setRecentPastes(mockRecentPastes);
      } catch (error) {
  ...
  const accountCreatedDate = new Date(user.createdAt || Date.now() - 30 * 86400 * 1000);
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
            <div className="text-center">
              <div className="relative inline-block">
                <img 
                  src={user.profileImage || `https://www.gravatar.com/avatar/${user.username}?d=mp&s=128`} 
                  ...
                  <div>
                    ...
                    <div className="mt-1 flex items-center">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
                        <i className="fas fa-check-circle mr-1"></i>
                        Member Since: {accountCreatedDate.toLocaleDateString()}
                      </span>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-1">
                      <span className="text-blue-600 dark:text-blue-400 font-medium">Free Account</span>
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">
            ...
            <div className="p-6">
              {isLoading ? (
                ...
                <div className="text-center py-8">
                  <i className="fas fa-clipboard text-gray-400 text-4xl mb-4"></i>
                  <p className="text-gray-500 dark:text-gray-400 mb-4">No recent activity to show</p>
                  <Link to="/" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg text-sm font-medium inline-flex items-center">
